...
"""
        messages = [
            ("system", "Think yourself as a CVPR reviewer, based on the tool results and your knowledge, what would be the best answer to the following question?"),
            ("user", final_prompt)
        ]
...
if __name__ == "__main__":
    rulebook = CVPRRulebook()
    query = "What are the rules to getting selected in CVPR?"
