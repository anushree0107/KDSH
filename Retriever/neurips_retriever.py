...
class NeurIPSRulebook:
    ...
    def read_data_sources(self):
        ...
        self.data_sources.append(
            pw.io.fs.read(
                "/mnt/c/Users/HP/OneDrive/Desktop/kdsh-task-2/KDSH/Retriever/Rulebook/neurips_rulebook.txt",
                format="binary",
                mode="streaming",
                with_metadata=True
            )
...
"""
        messages = [
            ("system", "Think yourself as a NeurIPS reviewer, based on the tool results and your knowledge, what would be the best answer to the following question?"),
            ("user", final_prompt)
        ]
...
if __name__ == "__main__":
    rulebook = NeurIPSRulebook()
    query = "What are the rules to getting selected in NeurIPS?"
